...
public class ChekBoxCommandOne extends ServiceCommand {
    ...
    private InlineKeyboardMarkup createKeyboard() {
        ...
        checkBoxComponent.addSender(
                new SendCheckBoxButton("Отправить", "sendCallbackData_1", checkBoxComponent.getItems()),
                new CancelCheckBoxButton("Сбросить", "cancelCallbackData_1", checkBoxComponent.getItems())
        );
